...
echo "  vpn-manager --help            # Show all available commands"
echo "  vpn-manager start             # Start all services"
echo "  vpn-manager list-servers      # List all servers"
echo "  vpn-manager add-client internet phone  # Add client"
echo ""
echo "Development tools (available globally):"
echo "  cd vpn-manager && ruff check .    # Run linter"
echo "  cd vpn-manager && ruff format .   # Format code"
echo "  cd vpn-manager && mypy .          # Type checking"
echo ""
echo "To run all checks:"
echo "  cd vpn-manager && ruff check . && mypy ."
echo ""
echo "To uninstall:"
echo "  pipx uninstall wireguard-vpn-manager"